		...
		if ( isset($_FILES["file"]) ) {
			...
			if ($_FILES["file"]["error"] > 0) {
				...
				#Check the mimetype to see if it's a valid CSV file - additional security may be required
					...
					#Successful upload
					echo "File uploaded successfully. Redirecting to review and import page.<br />Click <a href=import_cmdb_display_csv.php?csv=$new_filename>here</a> if your browser does not redirect you automatically.";
					header("refresh:3; url=import_cmdb_display_csv.php?csv=$new_filename");
				}
			}
		} 
		else {
