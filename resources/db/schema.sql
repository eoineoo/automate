...
(1, 'automate', 'config', 'id', '', '', '_', ''),
(2, 'automate', 'config', 'user', '', '', '_', ''),
(3, 'automate', 'config', 'end_user', '', '', '_', ''),
(4, 'automate', 'config', 'machine_name', '', '', '_', ''),
(6, 'automate', 'config', 'applications', '', '', '_', ''),
(7, 'automate', 'config', 'timestamp', '', '', '_', '');
...
('root', '2014-02-27 18:09:44', '{"collation_connection":"utf8mb4_general_ci"}');
--
-- Database: `swdata`
--
