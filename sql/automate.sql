...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2013 at 06:24 PM
...
INSERT INTO `import_data` (`id`, `orig_name`, `new_name`, `timestamp`, `user`, `num_entries`, `description`, `url`) VALUES
(11, '_hw_import.csv', '528a5020b5da6_hw_import.csv', '2013-11-18 17:36:32', 'emccrann', 100, '130 Dell, 140 HP', '/automate/import/csv/528a5020b5da6_hw_import.csv'),
(12, '_hw_import.csv', '528a51084ac15_hw_import.csv', '2013-11-18 17:40:24', 'emccrann', 100, '123', '/automate/import/csv/528a51084ac15_hw_import.csv'),
(13, '_hw_import.csv', '528a5191a7ce6_hw_import.csv', '2013-11-18 17:42:41', 'emccrann', 100, '213123', '/automate/import/csv/528a5191a7ce6_hw_import.csv'),
(14, 'mysql-connector-python-1.0.12-py3.3.msi', '528a51a5981b0mysql-connector-python-1.0.12-py3.3.msi', '2013-11-18 17:43:01', 'emccrann', 100, 'should not work', '/automate/import/csv/528a51a5981b0mysql-connector-python-1.0.12-py3.3.msi'),
(15, 'MySQL-python-1.2.4b4.win32-py2.7.exe.csv', '528a52d1c7f7aMySQL-python-1.2.4b4.win32-py2.7.exe.csv', '2013-11-18 17:48:01', 'emccrann', 100, 'test rename file extension', '/automate/import/csv/528a52d1c7f7aMySQL-python-1.2.4b4.win32-py2.7.exe.csv'),
(16, '_hw_import.csv', '528a57ec641a2_hw_import.csv', '2013-11-18 18:09:48', 'emccrann', 100, '12321312', '/automate/import/csv/528a57ec641a2_hw_import.csv'),
(17, '_hw_import.csv', '528a5812b500c_hw_import.csv', '2013-11-18 18:10:26', 'emccrann', 100, '12321312', '/automate/import/csv/528a5812b500c_hw_import.csv'),
(18, '_hw_import.csv', '528a5aca86802_hw_import.csv', '2013-11-18 18:22:02', 'emccrann', 100, 'jkjhkhjkh', '/automate/import/csv/528a5aca86802_hw_import.csv'),
(19, '_hw_import.csv', '528a5b3ba5929_hw_import.csv', '2013-11-18 18:23:55', 'emccrann', 100, '130 Dell, 140 HP - Sept 2013 Grad Intake', '/automate/import/csv/528a5b3ba5929_hw_import.csv');
